...
void load_data(Data& train_data, Data& test_data, Data& validation_data) {
	...
	for (int i = 0; i < 10000; ++i)
		for (int j = 0; j < 28 * 28; ++j)
			validation_data.examples(j, i) = file[j + i * 28 * 28] / 256.;
	for (int i = 10000; i < 60000; ++i)
		for (int j = 0; j < 28 * 28; ++j)
			train_data.examples(j, i - 10000) = file[j + i * 28 * 28] / 256.;
	...
	for (int i = 0; i < 10000; ++i)
		validation_data.labels(i) = file[i];
	for (int i = 10000; i < 60000; ++i)
		train_data.labels(i - 10000) = file[i];
